...
namespace Enterprise.ECommerce.ResourceServer.Migrations
{
    ...
    [Migration("20180206104147_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Enterprise.E_Commerce.NetStandard.DataLayers.ECommerceDB.BaseProductSpec", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnName("ID");
                    ...
                    b.ToTable("BaseProductSpec","Merchandise");
                });
            ...
            modelBuilder.Entity("Enterprise.E_Commerce.NetStandard.DataLayers.ECommerceDB.BaseProductSpec", b =>
                {
                    b.HasOne("Enterprise.E_Commerce.NetStandard.DataLayers.ECommerceDB.Product", "Product")
                        .WithMany("BaseProductSpec")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("FK_BaseProductSpec_Product");

                    b.HasOne("Enterprise.E_Commerce.NetStandard.DataLayers.ECommerceDB.ProductVariation", "ProductVariation")
                        .WithMany("BaseProductSpec")
                        .HasForeignKey("ProductVariationId")
                        .HasConstraintName("FK_BaseProductSpec_ProductVariation");
                });
